...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/v1/user/lookup/:id',
            ...(fetchMiddlewares<RequestHandler>(LookupController)),
            ...(fetchMiddlewares<RequestHandler>(LookupController.prototype.getUserByID)),

            function LookupController_getUserByID(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/v1/user/decode/:id',
            ...(fetchMiddlewares<RequestHandler>(LookupController)),
            ...(fetchMiddlewares<RequestHandler>(LookupController.prototype.decodeSnowflake)),

            function LookupController_decodeSnowflake(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
        ...
        app.get('/v1/user/calculate-snowflake-difference',
            ...(fetchMiddlewares<RequestHandler>(LookupController)),
            ...(fetchMiddlewares<RequestHandler>(LookupController.prototype.calculateSnowflakeDifference)),

            function LookupController_calculateSnowflakeDifference(request: any, response: any, next: any) {
            const args = {
